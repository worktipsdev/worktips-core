...
#define WORKTIPS_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/worktips_integration_test_hooks.h"

// NOTE(worktips): This file only exists because I need a way to hook into the
...
// worktips_integration_test_hooks.h functions which isn't possible to expose in
